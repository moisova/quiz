...
const questions = [
  new Question(
    "Алёна задумала число, прибавила к нему 5, потом разделила итоговое число на 3, умножила результат на 4, отняла 6, разделила на 7 и получила 2. Какое число задумала Алёна??",
    [
      new Answer("5", 0),
      new Answer("7", 0),
      new Answer("10", 1),
