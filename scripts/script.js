...
const questions = [
  new Question(
    "Дима задумал число, прибавил к нему 5, потом разделил итоговое число на 3, умножил результат на 4, отнял 6, разделил на 7 и получил 2. Какое число задумал Дима??",
    [
      new Answer("5", 0),
      new Answer("7", 0),
      new Answer("10", 1),
